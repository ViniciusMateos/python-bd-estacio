...
class Marca:
    def __init__(self, id, nome, sigla):
        self.id = id # Adicionamos o id ao construtor da classe Marca
                    # alteração foi feita para facilitar a criação do objeto do tipo Marca a partir da consulta no banco.
        self.nome = nome
        self.sigla = sigla
